...
const primeiroDivide = Number(numeroPergunta) % Number(numeroPergunta2) === 0
const segundoDivide =  Number(numeroPergunta2) % Number(numeroPergunta) === 0 
...
const farenheitKelvin = (a -32)*(5/9) + 273.15
console.log(farenheitKelvin)

const celsiusFarenheit = (b)*(9/5) + 32
console.log(celsiusFarenheit)

const ceD = prompt("insira celsius")
const converte = (ceD -32)*(5/9) + 273.15
const converte2 = (converte)*(9/5) + 32
